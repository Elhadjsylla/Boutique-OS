...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center items-center px-4 py-12">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl border border-outline-variant premium-shadow-lg p-8 flex flex-col gap-6 text-center animate-fade-in">
        {/* Logo Section */}
