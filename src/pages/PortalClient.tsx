          ...
          <div class="receipt-container">
              ...
              <tbody>
                ${paiements.map((p: any, idx: number) => `
                  <tr>
                    ...
                    <td style="text-align: right; font-weight: 900; color: #27AE60;">+ ${formatMontantFull(p.montant)} FCFA</td>
                  </tr>
                `).join('')}
                ${paiements.length === 0 ? `
                  <tr>
            ...
            <div class="total-card">
              <div class="total-row">
                ...
                <span style="font-weight: bold; color: #1A1A2E;">${formatMontantFull(ardoise.montant_total)} FCFA</span>
              </div>
              <div class="total-row">
                <span>Total Versé :</span>
                <span style="font-weight: bold; color: #27AE60;">${formatMontantFull(paid)} FCFA</span>
              </div>
              <div class="total-row">
                <span>Reste à Payer :</span>
                <span style="font-weight: 900;">${formatMontantFull(remaining)} FCFA</span>
              </div>
            </div>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary to-primary-container text-white p-6 rounded-[24px] shadow-lg border border-white/5 flex flex-col gap-4 text-left">
          ...
          <div className="flex flex-col gap-1.5 mt-2 z-10">
            <div className="flex justify-between text-[10px] font-bold">
              ...
              <span className="opacity-80">{formatMontantFull(paid)} / {formatMontantFull(ardoise.montant_total)} FCFA</span>
            </div>
